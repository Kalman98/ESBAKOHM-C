...
int main()
{
    ...
    Model testModel(FileSystem::getPath("resources/objects/grass/grass.obj"));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //model = glm::translate(model, glm::vec3(-0.8f, 1.6f, 0.2f)); // translate it down so it's at the center of the scene
        ourShader.setMat4("model", model);
